...
// DTOs
import { CreateGuardianRequest, GuardianResponse } from '../../dtos/user-management/guardian';
import { StandardRequestDto } from '@/core/modules/standard-response/dto/standard-request.dto';

// Mappers
import { GuardianInputMapper } from '../../mappers/guardian-input.mapper';
...
export class GuardianController {
  ...
  async create(@Body() dto: CreateGuardianRequest) {
    const input = GuardianInputMapper.toCreateInput(dto);
    return await this.createGuardianUseCase.execute(input);
  }
