...
export class PrismaQueryService {
    ...
    private buildFieldConditions(conditions: FilterConditionDto): Record<string, any> {
    ...
    async executeQuery<T>(
        ...
        const allowedSortFields = options.allowedSortFields || params.allowedSortFields || [];
        const allowedFilterFields = options.allowedFilterFields || params.allowedFilterFields || [];
