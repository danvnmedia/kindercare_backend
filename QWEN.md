# KinderCare Backend - AI Development Guide

**Code Patterns**: 
  See @PROJECT.md for Mapper, Controller, Use Case, Repository patterns.
**Project Overview**: 
  See @CLAUDE.md for architecture and development rules.
