/* FOR LLM: SEED FILE IS NOT BEING USED FOR NOW. IGNORE IT. */
...
//   // Tạo các vai trò người dùng (system defaults - không có campus)
//   // Note: Role.id is now UUID (auto-generated), using compound unique on (campus_id, name)
//   const baseRoles = [
//     {
//       name: 'admin',
...
//     // Use compound unique key (campusId, name) - null campusId for system defaults
//     await prisma.role.upsert({
//       where: {
//         campusId_name: {
//           campusId: null as unknown as string, // System default roles have no campus
//           name: role.name,
//         },
//       },
//       update: {
