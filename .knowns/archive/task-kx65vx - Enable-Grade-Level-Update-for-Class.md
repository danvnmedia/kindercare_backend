...
updatedAt: '2026-02-12T02:00:23.227Z'
timeSpent: 0
---
...
- [x] #11 PrismaClassMapper.toPrismaUpdate uses Prisma.ClassUncheckedUpdateInput (not ClassUpdateInput) so gradeLevelId is not silently dropped
- [x] #12 Frontend UpdateClassInput type includes gradeLevelId (not omitted)
- [x] #13 Frontend class-dialog.tsx sends gradeLevelId in the update payload
<!-- AC:END -->
