...
updatedAt: '2026-01-13T21:49:50.310Z'
description: PRD for frontend implementation of multi-campus architecture migration
tags:
  - prd
  - frontend
  - migration
...
| F2 | Implement campus selector component in app sidebar                                    | Must     |
| F3 | Store selected campus in global state (Redux/Context, anything currently being used.) | Must     |
...
* **UX**: Campus switch ideally not require page reload; update data in-place if possible. If not possible, reload page is ok
